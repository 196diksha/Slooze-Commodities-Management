  ...
  return (
    <div className="flex min-h-screen items-center justify-center p-4">
      <div className="panel w-full max-w-md p-6 md:p-7">
        ...
        <h1 className="mt-2 mb-1 text-3xl font-extrabold">Create account</h1>
        <p className="mb-6 text-sm muted">Register as Manager or Store Keeper</p>
        ...
        <form className="space-y-4" onSubmit={onSubmit}>
          ...
          <label className="block space-y-1.5">
            <span className="text-xs font-semibold uppercase tracking-[0.16em] muted">Role</span>
            <select
              value={role}
